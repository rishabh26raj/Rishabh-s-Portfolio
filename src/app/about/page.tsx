    ...
    <div>
      <div className="relative font-mono">
        <div className="container mx-auto px-10 md:px-15 lg:px-12 pt-28 lg:pt-40">
          ...
          >
            {/* Main Content */}
            <h1 className="text-5xl font-bold mb-12">Hi, I'm Rishabh!</h1>
          </AnimatedContent>
              ...
              <div className="flex justify-center">
                <div className="relative w-60 h-60 md:w-80 md:h-80">
                  <div className="overflow-hidden rounded-full w-full h-full">
                    <Image
                      src="/rishabh_portfolio_pic.jpeg"
                      alt="Rishabh's profile pic"
                      layout="fill"
                      objectFit="cover"
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-16 mb-16">
            ...
            >
              <div className="lg:max-w-4xl">
                ...
                <p className="mb-4">
                  Throughout my academic and professional journey, I have gained hands-on experience in various technical areas. I enjoy working on diverse projects that require both{" "}
                ...
                <p>
                  ...
                  to creating meaningful software solutions that have a
